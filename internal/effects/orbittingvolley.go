...
func (o *OrbittingVolley) build() {
	...
	// Build perimeter path for main launcher
...
func (o *OrbittingVolley) setLauncherCoordinates(parent, child *launcher) {
	...
	progress := float64(parent.character.Coord.Col-o.base.Canvas.Left) / float64(o.base.Canvas.Right-o.base.Canvas.Left)
	...
	if childInputCoord.Col == o.base.Canvas.Right && childInputCoord.Row == o.base.Canvas.Top {
		...
		childRow := o.base.Canvas.Top - int(float64(o.base.Canvas.Top-o.base.Canvas.Bottom)*progress)
		newCoord = utils.Coord{Col: o.base.Canvas.Right, Row: max(o.base.Canvas.Bottom, childRow)}
		...
		childCol := o.base.Canvas.Right - int(float64(o.base.Canvas.Right-o.base.Canvas.Left)*progress)
		newCoord = utils.Coord{Col: max(o.base.Canvas.Left, childCol), Row: o.base.Canvas.Bottom}
		...
		childRow := o.base.Canvas.Bottom + int(float64(o.base.Canvas.Top-o.base.Canvas.Bottom)*progress)
...
func (o *OrbittingVolley) Next() (string, bool) {
	...
	if hasCharacters || activeNonLaunchers > 0 {
		...
		if o.mainLauncher.character.Motion.ActivePath == nil {
			// Rebuild perimeter path from current position
			perimeterPath, _ := o.mainLauncher.character.Motion.NewPath(o.launcherMovementSpeed, nil, nil, 0, false, "perimeter")
			perimeterPath.AddWaypoint(utils.Coord{Col: o.base.Canvas.Right, Row: o.base.Canvas.Top})
			perimeterPath.AddWaypoint(utils.Coord{Col: o.base.Canvas.Left, Row: o.base.Canvas.Top})
		...
		// Update main launcher color based on position
		if color, ok := o.launcherGradientMap[o.mainLauncher.character.Coord]; ok {
			o.mainLauncher.character.SetVisual(engine.CharacterVisual{
				Symbol: o.mainLauncher.character.Symbol,
				Colors: &utils.ColorPair{FG: &color},
			})
		...
		// Update other launcher positions
